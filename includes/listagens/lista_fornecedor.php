<?php
  ...
  foreach($fornecedores as $fornecedor){
    $resultados .= '<tr>
                    <td>'.$fornecedor->codfor.'</td>
                    <td>'.$fornecedor->razfor.'</td>
                    <td>('.$fornecedor->dddfonefor.   ')'.$fornecedor->fonefor.'</td>
                    <td>('.$fornecedor->dddcelfor.')'.$fornecedor->celfor.'</td>
					<td>'.$fornecedor->endfor.', '.$fornecedor->numfor.'/'.$fornecedor->complfor.'</td>
                    <td>
                      <a href="edtunidade.php?id='.$fornecedor->id.'">
                        <button type="button" class="btn btn-primary">Editar</button>
                      </a>
                      <a href="excunidade.php?id='.$fornecedor->id.'">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="breadcomb-wp">
                ...
                <div class="breadcomb-ctn">
                  <h2>Fornecedores</h2>
                  <p>Listagem de <span>Fornecedores</span></p>
                </div>
              </div>
            </div>
                  ...
                  <div class="form-example-wrap">
                      ...
                      <div class="cmp-tb-hd">
                          <h2>Cadastrar <i class="fas fa-arrow-alt-circle-right"></i>
                              <a href='cadproduto.php'>
                                <button data-toggle="tooltip" data-placement="right" title="Cadastra Fornecedor" class="btn"><i class="notika-icon notika-sent"></i></button>
                              </a>
                          </h2>
                      </div>
