...
<head>
    ...
    <title>Alles - Simples Assim</title>
...
<body>
    ...
    <div class="login-content">
        <div class="nk-block toggled" id="l-login">
            <div class="nk-form">
                <div class="input-group">
                    ...
                    <div class="nk-int-st">
                        <input type="email" name="emailusu" class="form-control" placeholder="email" onchange="javascript:this.value=this.value.toLowerCase();" required>
                    </div>
                </div>
                <div class="input-group mg-t-15">
                    <span class="input-group-addon nk-ic-st-pro"><i class="notika-icon notika-edit"></i></span>
                    <div class="nk-int-st">
                        <input type="password" name="senhausu" class="form-control" placeholder="Senha" required>
                    </div>
                </div>
                <div class="fm-checkbox">
                    <label><input type="checkbox" class="i-checks"> <i></i>Ficar conectado</label>
                </div>
            ...
            <div class="nk-navigation nk-lg-ic">
                <button class="btn btn-success notika-btn-success" type="submit" name="acao" value="logar" ><i class="notika-icon notika-right-arrow"></i> <span>ACESSAR</span></button>
        ...
        <div class="nk-block" id="l-register">
            <div class="nk-form">
                ...
                <div class="input-group">
                    ...
                    <div class="nk-int-st">
                        <input type="text" name="nomeusu" class="form-control" placeholder="Nome" onchange="javascript:this.value=this.value.toUpperCase();" required>
                    </div>
                </div>
                ...
                <div class="input-group mg-t-15">
                    <span class="input-group-addon nk-ic-st-pro"><i class="notika-icon notika-mail"></i></span>
                    <div class="nk-int-st">
                        <input type="mail" name="emailusu" class="form-control" placeholder="Email" onchange="javascript:this.value=this.value.toLowerCase();" required>
                    </div>
                </div>
              ...
              <input type='hidden' name='ativousu'  value=''>
              <input type='hidden' name='visualizalucr' value='S'>
              <input type='hidden' name='cadoutusu' value='N'>
              <input type='hidden' name='nivel' value='5'>
              <input type='hidden' name='dtins' value='<?=date('Y-m-d');?>'>
              <input type='hidden' name='hins'  value='<?=date('H:i:s');?>'>
              <div class="nk-navigation rg-ic-stl">
                <button class="btn btn-success notika-btn-success" type="submit" name="acao" value="cadastrar" ><i class="notika-icon notika-right-arrow"></i> <span>REGISTRAR</span></button>
        ...
        <div class="nk-block" id="l-forget-password">
            <div class="nk-form">
                <p class="text-left">Informe o e-mail cadastrado para recuperação. Ou abra um chamado técnico <a href="www.nonoelemento.com.br/ni" target="_blank">aqui</a>.</p>

                <div class="input-group">
                    <span class="input-group-addon nk-ic-st-pro"><i class="notika-icon notika-mail"></i></span>
                    <div class="nk-int-st">
                        <input type="mail" class="form-control" placeholder="Email de recuperação">
                    </div>
                </div>
