                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                <li><a data-toggle="collapse" data-target="#Charts" href="#">Principal</a>
                                    <ul class="collapse dropdown-header-top">
                                        <li><a href="index.php">Dashboard</a></li>
                                        <li><a href="index-2.html">Compras</a></li>
                                        <li><a href="index-3.html">Vendas</a></li>
                                        <!--<li><a href="index-4.html">Dashboard Four</a></li>-->
                                        <li><a href="analytics.html">Analítico</a></li>
                                        <li><a href="widgets.html">Widgets</a></li>
                                    </ul>
                                </li>
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Cadastro</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                      <!--  <li><a href="inbox.html">Inbox</a></li>
                                        <li><a href="view-email.html">View Email</a></li>
                                        <li><a href="compose-email.html">Compose Email</a></li>-->
                                        <li><a href="marca.php">teste</a></li>
                                        <li><a href="compose-email.html">teste</a></li>
                                        <li><a href="compose-email.html">teste</a></li>
                                ...
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Fiscal</a>
                                    <ul id="demoevent" class="collapse dropdown-header-top">
                                        ...
                                        <li><a href="compose-email.html">Classificação Fiscal</a></li>
                                    </ul>
                                </li>
